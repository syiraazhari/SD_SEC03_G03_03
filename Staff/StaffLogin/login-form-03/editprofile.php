        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-6">
            <div class="form-block">
              ...
              $select = mysqli_query($conn, "SELECT * FROM `staff` WHERE  id = '$id'")or die('query failed');
              ...
              <form action="#" method="post">
                ...
                <div class="form-group first">
                  ...
                  <input type="text" name="update_username" value ="<?php echo $fetch['username']; ?>" class="form-control">
                </div>
