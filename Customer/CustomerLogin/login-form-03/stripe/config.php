...
//@define('STRIPE_SUCCESS_URL', 'http://18.191.142.36//dashboard/Customer/CustomerLogin/login-form-03/stripe/success.php'); 
//@define('STRIPE_CANCEL_URL', 'http://18.191.142.36/stripe/cancel.php'); 
