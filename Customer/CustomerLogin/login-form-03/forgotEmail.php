...
if(isset($_POST['submit'])){
    ...
    try {
        ...
        $mail->Body    = '<p>Your password reset link is: <b style="font-size: 10px;"> http://localhost/master%20project%20sd/Customer/CustomerLogin/login-form-03/forgot.php</b></p>';
       // $mail->Body    = '<p>Your password reset link is: <b style="font-size: 10px;"> http://18.222.181.248/dashboard/master%20project%20sd/Customer/CustomerLogin/login-form-03/forgot.php</b></p>';
